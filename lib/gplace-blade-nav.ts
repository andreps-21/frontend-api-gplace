...
export const gplaceBladeNavTree: GplaceNavNode[] = [
  { kind: "link", label: "Dashboard", href: "/dashboard", permission: "" },
  {
    ...
    children: [
      ...
      },
      {
        ...
        anyOf: CANANY_GERAIS,
        children: [
          { kind: "link", label: "Cupons", href: "/dashboard/admin/cupons", permission: "coupons_view", requiresStore: true },
          { kind: "link", label: "Unidades", href: "/dashboard/admin/unidades-negocio", permission: "businessunits_view", requiresStore: true },
          {
            kind: "link",
            label: "Formas de pagamento",
            href: "/dashboard/admin/formas-pagamento",
            permission: "payment-methods_view",
          },
          { kind: "link", label: "ERP", href: "/dashboard/admin/erp", permission: "erp_view" },
          { kind: "link", label: "Redes Sociais", href: "/dashboard/admin/redes-sociais", permission: "social-medias_view" },
          { kind: "link", label: "Cidades", href: "/dashboard/admin/cidades", permission: "cities_view" },
          { kind: "link", label: "Estados", href: "/dashboard/admin/estados", permission: "states_view" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      { kind: "link", label: "Estoque", href: "/dashboard/admin/estoque", permission: "products_view", requiresStore: true },
      { kind: "link", label: "Categorias", href: "/dashboard/admin/categorias", permission: "sections_view", requiresStore: true },
      { kind: "link", label: "Seções", href: "/dashboard/admin/secoes", permission: "sections_view", requiresStore: true },
      { kind: "link", label: "Grade de produto", href: "/dashboard/admin/grades-produto", permission: "grid_view", requiresStore: true },
      ...
      { kind: "link", label: "Regras de frete", href: "/dashboard/admin/regras-frete", permission: "freights_view", requiresStore: true },
      { kind: "link", label: "Mídias/Anúncios", href: "/dashboard/admin/banners", permission: "banners_view", requiresStore: true },
      { kind: "link", label: "Tamanho mídia", href: "/dashboard/admin/tamanhos-midia", permission: "size-image_view" },
      {
        kind: "link",
        label: "Posição na interface",
        href: "/dashboard/admin/posicoes-interface",
